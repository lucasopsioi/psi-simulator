...
Sell-in / sell-out / inventory simulator (single-file Electron app). This commit is a sanitized snapshot of **V83**; see the latest commit on `main` for the full README, screenshots and changelog.
